  ...
  <div id="zjyy">
        <div>
            <div style="height: 50px; background-color:#aaa;position:relative;padding-top:10px;border-radius:5px;">
                <b style="position:absolute;left:30px;">专家姓名</b>
                <b style="position:absolute;left:12%;">患者姓名</b>
            ...
            <div class="table" style="padding: 20px;">
                ...
                <span style="position:absolute;left:10px;">{{item.expertName}}</span>
                <span style="position:absolute;left:11%;">{{item.costumerName}}</span>
        ...
        <div id="ypdgDetails" style="position:fixed;left:0;right:0;bottom:0;top:0;background: rgba(0,0,0,0.7);display:none;">
            ...
            style="width:800px;min-height:250px;background-color:#fff;margin:150px auto;position:relative;border-radius:20px;overflow:auto;padding-bottom:20px;">
                ...
                <div style="width:600px;padding:20px;">
                    <!-- {"idCard":"example","expertName":"example","openid":"example","id":21,"tel":"example","costumerName":"example","time":"2018-12-22 22:00:26","hospital":"西南医科大学"} -->
                    <div style="height:40px;line-height:40px;border-bottom:1px solid #eee;">预约医院：{{currentDetail.hospital}}</div>
                    ...
                    <div style="height:40px;line-height:40px;border-bottom:1px solid #eee;">专家姓名：{{currentDetail.expertName}}</div>
                    <div style="height:40px;line-height:40px;border-bottom:1px solid #eee;">身份证号：{{currentDetail.idCard}}</div>
                    <div style="height:40px;line-height:40px;border-bottom:1px solid #eee;">患者姓名：{{currentDetail.costumerName}}</div>
