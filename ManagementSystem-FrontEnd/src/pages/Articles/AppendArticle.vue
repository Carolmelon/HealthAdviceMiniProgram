      ...
      <!-- <div class="row" style="margin-bottom: 20px;">
        ...
        <div class="row-right-div">
          ...
          <div style="float: left; height: 40px;">
            <el-radio v-model="arrangeStatus" label="1">无限制</el-radio>
            <el-radio v-model="arrangeStatus" label="2">发布</el-radio>
            <el-radio v-model="arrangeStatus" label="3">下线</el-radio>
          </div>
        </div>
      </div> -->
...
export default {
  ...
  methods: {
    ...
    uploadArticle() {
      ...
      var url = this.HOST + "/wx_mini/appendArticle";
      $.post(url,{
